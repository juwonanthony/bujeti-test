...
const MetaTags = () => {
  return (
    <Head>
      ...
      <meta property="og:title" content="Bujeti - Budgeting and Expense management tools for Africans by Africans" />
      <meta
      ...
      <meta property="twitter:title" content="Bujeti - Budgeting and Expense management tools for Africans by Africans" />
      <meta
