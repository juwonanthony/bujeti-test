  ...
  return (
    <div className={`items-center space-x-3.75 text-grey-divider ${className}`}>
      ...
      <div className="flex items-center space-x-3.75">
        <a href="https://www.twitter.com/bujetihq/" target="_blank" className="hover:text-accent-green">
        ...
        <a href="https://www.instagram.com/bujetihq/" target="_blank" className="hover:text-accent-green" rel="noreferrer">
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            <path
