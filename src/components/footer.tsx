      ...
      <div className="body-padding bg-black py-16 sm:py-20 lg:py-25 xl:py-30 flex-1 min-h-full flex md:items-center">
        <div className="container flex flex-col md:flex-row md:items-center justify-between flex-wrap h-full">
          <div className=" mb-8 mt-5 md:mb-0 md:mt-0 md:mr-5 flex-1 lg:min-w-[420px]">
            ...
            <div className="items-center mt-25 space-x-3.75 text-grey-divider hidden md:flex">
          ...
          <EarlyAccessFrom />
          <div className="items-center mt-10 space-x-3.75 text-grey-divider flex md:hidden">
            <span className="text-1sm inline-block pt-1">© 2021 Bujeti Inc.</span>
            <span>&bull;</span>
            <div className="flex items-center space-x-3.75">
              <a href="" className="hover:text-accent-green">
