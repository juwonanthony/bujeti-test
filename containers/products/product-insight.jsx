      ...
      <div className="container mx-auto ">
        <div className="flex justify-between">
          <div className="w-[580px]">
            ...
            <h1 className="py-6 text-6xl font-semibold text-white">
              Saving time. Selling <br /> even faster.
            </h1>
            <p className="text-xl text-white">
              <b>Connect your tools, connect your teams.</b> With over 100 apps available in our
              directory, your team’s favourite tolls are just a click away.
            </p>
          ...
          <div className="w-[420px]">
            <div className="pb-[30px]">
              <h1 className="text-6xl font-semibold text-accent-green">25.2 sec</h1>
              <p className="pt-[5px] text-base text-grey-semi">
                Average processing time for invoice reimbursements after an approval.
              </p>
            </div>
            <div className="border-y border-grey-accent py-[30px]">
              <h1 className="text-6xl font-semibold text-accent-green">₦987,843.32</h1>
              <p className="pt-[5px] text-base text-grey-semi">
                Our insights and pricing intelligence save thousands for 100+ companies just like
                yours.
              </p>
            </div>
            <div className="pt-[30px]">
              <h1 className="text-6xl font-semibold text-accent-green">95%</h1>
              <p className="pt-[5px] text-base text-grey-semi">
                Users are satisfied and feels Bujeti is easy to use.
              </p>
            </div>
          </div>
        </div>
