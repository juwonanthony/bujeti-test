      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-3 gap-8 pt-15">
          <div className="flex flex-col">
            ...
            <h1 className="py-1 text-xl text-accent-orange">Simple, smart & secure.</h1>
            <p className="text-base text-blue-light">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="py-1 text-xl text-accent-orange">Bye to errors & fraud.</h1>
            <p className="text-base text-blue-light">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="py-1 text-xl text-accent-orange">Forget risky cash management.</h1>
            <p className="text-base text-blue-light">
              Define and enforce spending limits. Nothing falls through the cracks.
            </p>
          </div>
