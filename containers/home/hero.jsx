...
const Hero = ({ hero }) => {
  return (
    <section className="container mx-auto flex flex-col items-center px-5 pt-5 md:min-h-[40rem] md:justify-center md:pt-30 lg:min-h-[40rem] lg:justify-center lg:pt-30">
