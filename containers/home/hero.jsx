...
const Hero = ({ hero }) => {
  return (
    <section className="container mx-auto flex flex-col items-center px-5 pt-25 md:min-h-[40rem] md:justify-center md:pt-20 lg:min-h-[40rem] lg:justify-center xl:pt-30">
